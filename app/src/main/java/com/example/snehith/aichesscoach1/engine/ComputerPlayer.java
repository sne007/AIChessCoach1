package com.example.snehith.aichesscoach1.engine;

import com.example.snehith.aichesscoach1.gamelogic.Move;
import com.example.snehith.aichesscoach1.gamelogic.MoveGen;
import com.example.snehith.aichesscoach1.gamelogic.Position;
import com.example.snehith.aichesscoach1.gamelogic.SearchListener;
import com.example.snehith.aichesscoach1.gamelogic.TextIO;
import com.example.snehith.aichesscoach1.gamelogic.UndoInfo;
...
//			Log.d("tag","reading stockfish",new Exception());
...
//					Log.d("statScore",Integer.toString(statScore),new Exception());
